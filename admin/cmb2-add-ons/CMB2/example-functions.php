...
add_action( 'cmb2_admin_init', 'yourprefix_register_plugin_demo_metabox' );
/**
 * Hook in and add a plugin_demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function yourprefix_register_plugin_demo_metabox() {
	$prefix = 'yourprefix_plugin_demo_';

	/**
	 * Sample metabox to plugin_demonstrate each field type included
	 */
	...
	$cmb_plugin_demo->add_field( array(
...
/**
 * Hook in and add a metabox to plugin_demonstrate repeatable grouped fields
 */
function yourprefix_register_repeatable_group_field_metabox() {
	...
	// $group_field_id is the field id string, so in this case: $prefix . 'plugin_demo'
	$group_field_id = $cmb_group->add_field( array(
		'id'          => $prefix . 'plugin_demo',
		'type'        => 'group',
